...
import com.wzy.helptravel.ui.ChatActivity;
    ...
    public Object getAvatar() {
        if (cType == BmobIMConversationType.PRIVATE){
            ...
            if (TextUtils.isEmpty(avatar)){//头像为空，使用默认头像
                return R.mipmap.default_avator;
            }else{
                return avatar;
            }
        }else{
    ...
    public void onClick(final Context context) {
        ...
        UserModel.getInstance().queryUserInfo(conversation.getConversationId(), new QueryUserListener() {
            ...
            public void done(User s, BmobException e) {
                if (e == null){
                    conversation.setConversationTitle(s.getNickName() == null ? s.getUsername() : s.getNickName());
